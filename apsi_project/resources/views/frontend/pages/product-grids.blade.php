...
@section('title', trans('frontend.side_title') . ' || ' . trans('frontend.product'))
...
@if($products)
    @foreach($products as $product)
        <div class="modal fade" id="{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel{{ $product->id }}" aria-hidden="true">
